...
const ListMeasurements = () => {
  ...
  const [popupType, setPopupType] = useState('info'); // 'info' or 'error'
    ...
    const confirmDelete = async () => {
      ...
      const userMeasurements = measurements.filter(measurement => measurement.userId === userId);
  ...
  return (
    ...
    <Link to="/addMeasurements" className="flex items-center ml-5 mb-4 mt-5 text-white text-xl font-mclaren px-2 py-1 bg-blue-500 hover:bg-blue-800 rounded-3xl">
      ...
      <h2 className="text-2xl font-bold text-blue-800 mt-0 mb-4">Measurements List</h2>
        ...
        <table className="min-w-full leading-normal opacity-80 bg-white">
          <thead className="font-bold text-left text-blue-800 bg-blue-100 rounded-t-3xl">
            <tr>
              ...
              <th className="px-5 py-3 border-b-2 border-gray-200">Undertone</th>
